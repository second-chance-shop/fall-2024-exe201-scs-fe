    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="w-[915px] text-[16px] leading-6">
                <div className="text-[16px] leading-[24px] flex flex-col relative max-w-[915px] pl-[45px] mb-[36px]">
                    <div>
                        <img
                            ...
                            className="text-[16px] leading-[24px] max-w-full align-top w-[33px] h-[33px] absolute left-[2px] top-[-2px]"
                        />
                        ...
                        <div className="text-[16px] leading-6 text-[#222] mt-[10px]">
                ...
                <h2 className="text-[24px] leading-[28px] font-semibold text-center mb-[27px]">
                    Security &amp; Privacy
                </h2>
            </div>
        </div>
